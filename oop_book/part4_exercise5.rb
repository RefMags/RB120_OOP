...
=begin
- Move all the method from `MyCar` class that pertain to the `MyTruck`  into
`Vehicle` class.
- Ensure all previous methods are working
=end
...
puts my_car.self_drive("self driven")
puts my_truck.self_drive("not self driven")
